...
@register(outgoing=True,pattern='^.cuh(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("**BACOTAN LU AJA NGEBALIKIN FAKTA DARI KEHIDUPAN LU TOLOL, LU TUH GAK PUNYA BEGO, LU DIKEHIDUPAN NYATA CUMA JADI BABU TONGKRONGAN, MAKANYA LU SO KERAS DI DUMAI KENTOT,KASIAN BET GUA AMA LU UDAH DITINGGAL IBU TERUS BAPAK SEKARAT MAU MATI NYUSUL LONTE NYA XIXIXI LU DI KEHIDUPAN NYATA TUH BEBAN KELUARGA SAMA SODARA CUMA NUMPANG MAKAN TIDUR KERJA KAGAK CUMA NGEMIS DOANG MAKANYA LU MIKIR KASIAN ORTU LU UDAH CAPE² NGELONTE SAMPE MATI TERUS BAPAK LU KULI KERAS SAMPE KETIBAN RERNTUHAN, LU MIKIR BEGO. KEK YANG IYA AJA IDUP LU PADAHAL SAMPAH KELUARGA CUIHHH..**")
...
CMD_HELP.update({
    ...
    \n•CMD: `.cuh`\
    \n•penjelasan: bacotan ngebalikin fakta."
})
